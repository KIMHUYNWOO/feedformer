...
def parse_args():
    ...
    parser.add_argument('--config',  default='/home/cv-05/FeedFormer/FeedFormer-master/local_configs/feedformer/B2/feedformer.b2.1024x1024.city.160k.py', help='train config file path')
    ...
    # Set the rank if not already set
