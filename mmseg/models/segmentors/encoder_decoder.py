...
class EncoderDecoder(BaseSegmentor):
    ...
    def _decode_head_forward_test(self, x, img_metas):
        ...
        #         # Update or append
        #         df = df[df['image_name'] != image_name]  # Remove if exists
        #         df = pd.concat([df, new_data], ignore_index=True)
        #     else:
        #         df = new_data
            
        #     # Save to CSV without empty rows
    ...
    def inference(self, img, img_meta, rescale):
        ...
        # Get image name from img_meta
        # image_name = os.path.basename(img_meta[0]['filename'])
    ...
    def simple_test(self, img, img_meta, rescale=True):
        ...
        # try:
        #     df = pd.read_csv(csv_path)
        #     # Update if image already exists, append if it doesn't
